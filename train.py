...
class Train:
    ...
    def __init__(self,root):
        ...
        #Top Image
        img_top = Image.open(r"E:\Jupyter\6SEM\image\face.jpg")
        img_top = img_top.resize((1530,325),Image.ANTIALIAS)
        self.photoimg_top = ImageTk.PhotoImage(img_top)

        f_label = Label(self.root,image = self.photoimg_top)
        f_label.place(x=0,y=55,width=1530,height=320)
        ...
        #Bottom Image
        img_bottom = Image.open(r"E:\Jupyter\6SEM\image\face1.jpg")
    ...
    def train_classifier(self):
        ...
        for image in path:
            ...
            image_np = np.array(img,'uint8')   # Convert img into numpy array and uint8 is a datatype
            #E:\Jupyter\6SEM\data\ user.1.1.jpg
            # 0                     1[0,1,2,3]
