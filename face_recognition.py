...
class Face_recognition:
    ...
    def __init__(self,root):
        ...
        #Top Image
        img_top = Image.open(r"E:\Jupyter\6SEM\image\detect.jpg")
        ...
        #Bottom Image
        img_bottom = Image.open(r"E:\Jupyter\6SEM\image\detect2.jpg")
        ...
        #Button
        b1_1 = Button(f_label,text="Face Recognition",command=self.face_recog,cursor="hand2",font=("times new roman",18,"bold"),bg="darkgreen",fg="white")
        b1_1.place(x=350,y=600,width=200,height=60)

    #=========Attendance===========
    def mark_attendance(self,i,r,n,d):
        with open("attendance.csv","r+",newline="\n") as f: #add attendance in csv
            my_data_list =f.readlines()
            name_list = []
            for line in my_data_list:
                entry= line.split((",")) #split the data using comma
    ...
    def face_recog(self):
        def draw_boundray(img,classifier,scaleFactor,minNeighbors,color,text,clf):
            ...
            for(x,y,w,h) in features:
                ...
                my_cursor.execute("select stud_name from student where stud_id="+str(user_id))
                ...
                my_cursor.execute("select stud_id from student where stud_id="+str(user_id))
                ...
                if confidence>78:
                    ...
                    cv2.putText(img,f"stud_name:{n}",(x,y-55),cv2.FONT_HERSHEY_COMPLEX,0.8,(255,255,255),3)
